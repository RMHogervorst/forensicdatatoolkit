test_that("Seek vector works", {
  ...
  sd_here <- 1.561
  n <- 45
  vec <- seek_sprite_vector(mean = mean_here, sd = sd_here, n = n, scale_min = 1, scale_max = 7, dp = 3)
...
test_that("get sample creates correct samples", {
  ...
  samples_shiny <- get_sprite_samples_matrix(max_cases = 9, n = 45, mean = 3.533, sd = 1.561, scale_min = 1, scale_max = 7, dp = 3, fixed = c())
